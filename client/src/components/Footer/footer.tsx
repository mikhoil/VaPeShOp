                ...
                <div className="footer__row footer-main">
                    <div className="footer-main__menu">
                        ...
                        <div className="footer-main__menu-block">
                            ...
                            <div className="footer-main__menu-list">
                                <div className="footer-main__menu-item">
                                    <Link className="footer-main__menu-link" to="/delivery-payment">Доставка и оплата</Link>
                                </div>
                                <div className="footer-main__menu-item">
                                    <Link className="footer-main__menu-link" to={location.pathname}>Оферта</Link>
                                </div>
                                <div className="footer-main__menu-item">
                                    <Link className="footer-main__menu-link" to={location.pathname}>Помощь</Link>
                                </div>
                                <div className="footer-main__menu-item">
                                    <Link className="footer-main__menu-link" to={location.pathname}>Гарантии</Link>
                                </div>
                                <div className="footer-main__menu-item">
                                    <Link className="footer-main__menu-link" to="/contacts">Контакты</Link>
                                </div>
                                <div className="footer-main__menu-item">
                                    <Link className="footer-main__menu-link" to="/reviews">Отзывы</Link>
                                </div>
                            </div>
                        </div>
                    </div>
